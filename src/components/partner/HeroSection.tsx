        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div className="flex flex-col justify-center order-2 lg:order-1" initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <div>
              <button
                ...
                className="inline-flex items-center justify-center gap-3 text-white px-8 py-5 rounded-xl hover:brightness-110 transition-all font-bold text-lg shadow-lg hover:-translate-y-1 w-fit"
          ...
          <motion.div className="order-1 lg:order-2 flex justify-center" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            <img 
              ...
              className="w-full h-auto max-w-[450px] lg:max-w-[600px] object-contain drop-shadow-2xl" 
            />
          </motion.div>
