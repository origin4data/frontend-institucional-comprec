...
export function Hero() {
  return (
    <section className="relative px-4 sm:px-8 pt-12 md:pt-20 z-10" style={{ backgroundColor: '#FDFDFD' }}>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-end justify-between gap-8 lg:gap-16">
          ...
          >
            <img
              ...
              className="w-auto h-[350px] sm:h-[450px] md:h-[550px] lg:h-[650px] object-contain object-bottom -mb-12 md:-mb-24 lg:-mb-32 drop-shadow-2xl rounded-2xl relative z-20"
            />
          </motion.div>
        </div>
      </div>
